...
| 4 | Icon theme | Cupertino-Sonoma (status/tray) + WhiteSur-light (apps) + Papirus (fallback) |
...
- [Cupertino-Sonoma icon theme](https://github.com/USBA/Cupertino-Sonoma-iCons) — macOS Sonoma-style status/tray icons
- [Papirus icon theme](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) — app indicator fallback (6,680+ panel icons)
...
- **Tray/panel icons**: Cupertino-Sonoma (macOS Sonoma design) is the primary icon theme. WhiteSur-light provides app icons as fallback. Papirus covers app-specific indicator icons (6,680+ panel icons). Inheritance chain: Cupertino-Sonoma → WhiteSur-light → Papirus → Adwaita → hicolor.
...
- [Cupertino-Sonoma Icon Theme](https://github.com/USBA/Cupertino-Sonoma-iCons) by USBA — for personal use
